...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dsd(&mut self) -> DSD_W<CGATSET0_SPEC, 1> {
        DSD_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccu42(&mut self) -> CCU42_W<CGATSET0_SPEC, 4> {
        CCU42_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccu81(&mut self) -> CCU81_W<CGATSET0_SPEC, 8> {
        CCU81_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn posif1(&mut self) -> POSIF1_W<CGATSET0_SPEC, 10> {
        POSIF1_W::new(self)
    }
