...
pub type CCU43_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, CCU43_AW>;
impl<'a, REG, const O: u8> CCU43_W<'a, REG, O>
where
...
pub type USIC2_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, USIC2_AW>;
impl<'a, REG, const O: u8> USIC2_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccu43(&mut self) -> CCU43_W<CGATSET1_SPEC, 0> {
        CCU43_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn usic2(&mut self) -> USIC2_W<CGATSET1_SPEC, 8> {
        USIC2_W::new(self)
    }
