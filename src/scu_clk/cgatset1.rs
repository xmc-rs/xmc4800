...
pub type CCU43_W<'a, const O: u8> = crate::BitWriter<'a, CGATSET1_SPEC, O, CCU43_AW>;
impl<'a, const O: u8> CCU43_W<'a, O> {
    #[doc = "No effect"]
    #[inline(always)]
...
pub type USIC2_W<'a, const O: u8> = crate::BitWriter<'a, CGATSET1_SPEC, O, USIC2_AW>;
impl<'a, const O: u8> USIC2_W<'a, O> {
    #[doc = "No effect"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccu43(&mut self) -> CCU43_W<0> {
        CCU43_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn usic2(&mut self) -> USIC2_W<8> {
        USIC2_W::new(self)
    }
