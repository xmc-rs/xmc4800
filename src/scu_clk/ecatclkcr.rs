...
impl ECATSELR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            ECATSELR::VALUE1 => false,
            ECATSELR::VALUE2 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> ECATSELR {
        match value {
            false => ECATSELR::VALUE1,
            true => ECATSELR::VALUE2,
        }
    }
    #[doc = "Checks if the value of the field is `VALUE1`"]
    #[inline]
    pub fn is_value1(&self) -> bool {
        *self == ECATSELR::VALUE1
    }
    #[doc = "Checks if the value of the field is `VALUE2`"]
    #[inline]
    pub fn is_value2(&self) -> bool {
        *self == ECATSELR::VALUE2
    }
}
#[doc = r" Proxy"]
...
impl ECATSELW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            ECATSELW::VALUE1 => false,
            ECATSELW::VALUE2 => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _ECATSELW<'a> {
    ...
    pub fn value1(self) -> &'a mut W {
        self.variant(ECATSELW::VALUE1)
    }
    #[doc = "fPLLclock"]
    #[inline]
    pub fn value2(self) -> &'a mut W {
        self.variant(ECATSELW::VALUE2)
    }
