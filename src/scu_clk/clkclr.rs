...
pub type EBUCDI_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, EBUCDI_AW>;
impl<'a, REG, const O: u8> EBUCDI_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ebucdi(&mut self) -> EBUCDI_W<CLKCLR_SPEC, 3> {
        EBUCDI_W::new(self)
    }
