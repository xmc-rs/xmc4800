...
pub type EBUCEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, EBUCEN_AW>;
impl<'a, REG, const O: u8> EBUCEN_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ebucen(&mut self) -> EBUCEN_W<CLKSET_SPEC, 3> {
        EBUCEN_W::new(self)
    }
