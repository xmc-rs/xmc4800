...
pub type DSD_W<'a, const O: u8> = crate::BitWriter<'a, CGATCLR0_SPEC, O, DSD_AW>;
...
pub type CCU42_W<'a, const O: u8> = crate::BitWriter<'a, CGATCLR0_SPEC, O, CCU42_AW>;
...
pub type CCU81_W<'a, const O: u8> = crate::BitWriter<'a, CGATCLR0_SPEC, O, CCU81_AW>;
...
pub type POSIF1_W<'a, const O: u8> = crate::BitWriter<'a, CGATCLR0_SPEC, O, POSIF1_AW>;
