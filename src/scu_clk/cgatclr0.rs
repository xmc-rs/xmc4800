...
pub type DSD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, DSD_AW>;
impl<'a, REG, const O: u8> DSD_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
...
pub type CCU42_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, CCU42_AW>;
impl<'a, REG, const O: u8> CCU42_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
...
pub type CCU81_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, CCU81_AW>;
impl<'a, REG, const O: u8> CCU81_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
...
pub type POSIF1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, POSIF1_AW>;
impl<'a, REG, const O: u8> POSIF1_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dsd(&mut self) -> DSD_W<CGATCLR0_SPEC, 1> {
        DSD_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccu42(&mut self) -> CCU42_W<CGATCLR0_SPEC, 4> {
        CCU42_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccu81(&mut self) -> CCU81_W<CGATCLR0_SPEC, 8> {
        CCU81_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn posif1(&mut self) -> POSIF1_W<CGATCLR0_SPEC, 10> {
        POSIF1_W::new(self)
    }
