...
pub type PD8_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O, PD8_A>;
...
pub type PD9_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O, PD9_A>;
...
pub type PD10_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O, PD10_A>;
...
pub type PD11_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O, PD11_A>;
...
pub type PD14_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O, PD14_A>;
...
pub type PD15_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O, PD15_A>;
