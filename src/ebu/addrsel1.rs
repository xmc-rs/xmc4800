...
pub type REGENAB_W<'a, const O: u8> = crate::BitWriter<'a, ADDRSEL1_SPEC, O, REGENAB_A>;
...
pub type ALTENAB_W<'a, const O: u8> = crate::BitWriter<'a, ADDRSEL1_SPEC, O, ALTENAB_A>;
...
pub type WPROT_W<'a, const O: u8> = crate::BitWriter<'a, ADDRSEL1_SPEC, O, WPROT_A>;
