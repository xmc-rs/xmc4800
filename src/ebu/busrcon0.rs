...
pub type FETBLEN_W<'a, const O: u8> = crate::FieldWriter<'a, BUSRCON0_SPEC, 3, O, FETBLEN_A>;
...
pub type FBBMSEL_W<'a, const O: u8> = crate::BitWriter<'a, BUSRCON0_SPEC, O, FBBMSEL_A>;
...
pub type BFSSS_W<'a, const O: u8> = crate::BitWriter<'a, BUSRCON0_SPEC, O, BFSSS_A>;
...
pub type FDBKEN_W<'a, const O: u8> = crate::BitWriter<'a, BUSRCON0_SPEC, O, FDBKEN_A>;
...
pub type BFCMSEL_W<'a, const O: u8> = crate::BitWriter<'a, BUSRCON0_SPEC, O, BFCMSEL_A>;
...
pub type NAA_W<'a, const O: u8> = crate::BitWriter<'a, BUSRCON0_SPEC, O>;
...
pub type ECSE_W<'a, const O: u8> = crate::BitWriter<'a, BUSRCON0_SPEC, O, ECSE_A>;
...
pub type EBSE_W<'a, const O: u8> = crate::BitWriter<'a, BUSRCON0_SPEC, O, EBSE_A>;
...
pub type DBA_W<'a, const O: u8> = crate::BitWriter<'a, BUSRCON0_SPEC, O, DBA_A>;
...
pub type WAITINV_W<'a, const O: u8> = crate::BitWriter<'a, BUSRCON0_SPEC, O, WAITINV_A>;
...
pub type BCGEN_W<'a, const O: u8> = crate::FieldWriter<'a, BUSRCON0_SPEC, 2, O, BCGEN_A>;
...
pub type PORTW_W<'a, const O: u8> = crate::FieldWriter<'a, BUSRCON0_SPEC, 2, O>;
...
pub type WAIT_W<'a, const O: u8> = crate::FieldWriter<'a, BUSRCON0_SPEC, 2, O>;
...
pub type AAP_W<'a, const O: u8> = crate::BitWriter<'a, BUSRCON0_SPEC, O, AAP_A>;
...
pub type AGEN_W<'a, const O: u8> = crate::FieldWriter<'a, BUSRCON0_SPEC, 4, O>;
impl R {
