...
pub type BFSSS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, BFSSS_A>;
impl<'a, REG, const O: u8> BFSSS_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Two stages of synchronization used. (maximum margin)"]
...
pub type FDBKEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, FDBKEN_A>;
impl<'a, REG, const O: u8> FDBKEN_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "BFCLK feedback not used."]
...
pub type BFCMSEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, BFCMSEL_A>;
impl<'a, REG, const O: u8> BFCMSEL_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Burst Flash Clock runs continuously with values selected by this register"]
...
pub type NAA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DBA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, DBA_A>;
impl<'a, REG, const O: u8> DBA_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Memory Controller automatically re-aligns any non-aligned synchronous burst access so that data can be fetched from the device in a single burst transaction."]
...
pub type PORTW_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fetblen(&mut self) -> FETBLEN_W<BUSRCON3_SPEC, 0> {
        FETBLEN_W::new(self)
    }
    #[doc = "Bit 3 - Synchronous burst buffer mode select"]
    #[inline(always)]
    #[must_use]
    pub fn fbbmsel(&mut self) -> FBBMSEL_W<BUSRCON3_SPEC, 3> {
        FBBMSEL_W::new(self)
    }
    #[doc = "Bit 4 - Read Single Stage Synchronization:"]
    #[inline(always)]
    #[must_use]
    pub fn bfsss(&mut self) -> BFSSS_W<BUSRCON3_SPEC, 4> {
        BFSSS_W::new(self)
    }
    #[doc = "Bit 5 - Burst FLASH Clock Feedback Enable"]
    #[inline(always)]
    #[must_use]
    pub fn fdbken(&mut self) -> FDBKEN_W<BUSRCON3_SPEC, 5> {
        FDBKEN_W::new(self)
    }
    #[doc = "Bit 6 - Burst Flash Clock Mode Select"]
    #[inline(always)]
    #[must_use]
    pub fn bfcmsel(&mut self) -> BFCMSEL_W<BUSRCON3_SPEC, 6> {
        BFCMSEL_W::new(self)
    }
    #[doc = "Bit 7 - Enable flash non-array access workaround"]
    #[inline(always)]
    #[must_use]
    pub fn naa(&mut self) -> NAA_W<BUSRCON3_SPEC, 7> {
        NAA_W::new(self)
    }
    #[doc = "Bit 16 - Early Chip Select for Synchronous Burst"]
    #[inline(always)]
    #[must_use]
    pub fn ecse(&mut self) -> ECSE_W<BUSRCON3_SPEC, 16> {
        ECSE_W::new(self)
    }
    #[doc = "Bit 17 - Early Burst Signal Enable for Synchronous Burst"]
    #[inline(always)]
    #[must_use]
    pub fn ebse(&mut self) -> EBSE_W<BUSRCON3_SPEC, 17> {
        EBSE_W::new(self)
    }
    #[doc = "Bit 18 - Disable Burst Address Wrapping"]
    #[inline(always)]
    #[must_use]
    pub fn dba(&mut self) -> DBA_W<BUSRCON3_SPEC, 18> {
        DBA_W::new(self)
    }
    #[doc = "Bit 19 - Reversed polarity at WAIT"]
    #[inline(always)]
    #[must_use]
    pub fn waitinv(&mut self) -> WAITINV_W<BUSRCON3_SPEC, 19> {
        WAITINV_W::new(self)
    }
    #[doc = "Bits 20:21 - Byte Control Signal Control"]
    #[inline(always)]
    #[must_use]
    pub fn bcgen(&mut self) -> BCGEN_W<BUSRCON3_SPEC, 20> {
        BCGEN_W::new(self)
    }
    #[doc = "Bits 22:23 - Device Addressing Mode"]
    #[inline(always)]
    #[must_use]
    pub fn portw(&mut self) -> PORTW_W<BUSRCON3_SPEC, 22> {
        PORTW_W::new(self)
    }
    #[doc = "Bits 24:25 - External Wait Control: 0=OFF (default after reset)., 1=Asynchronous input at WAIT., 2=Synchronous input at WAIT., 3=reserved., 0=OFF (default after reset)., 1=Wait for page load (Early WAIT)., 2=Wait for page load (WAIT with data)., 3=Abort and retry access.,"]
    #[inline(always)]
    #[must_use]
    pub fn wait(&mut self) -> WAIT_W<BUSRCON3_SPEC, 24> {
        WAIT_W::new(self)
    }
    #[doc = "Bit 26 - Asynchronous Address phase:"]
    #[inline(always)]
    #[must_use]
    pub fn aap(&mut self) -> AAP_W<BUSRCON3_SPEC, 26> {
        AAP_W::new(self)
    }
    #[doc = "Bits 28:31 - Device Type for Region"]
    #[inline(always)]
    #[must_use]
    pub fn agen(&mut self) -> AGEN_W<BUSRCON3_SPEC, 28> {
        AGEN_W::new(self)
    }
