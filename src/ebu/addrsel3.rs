...
pub struct R(crate::R<ADDRSEL3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ADDRSEL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ADDRSEL3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ADDRSEL3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ADDRSEL3` writer"]
pub struct W(crate::W<ADDRSEL3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ADDRSEL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ADDRSEL3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ADDRSEL3_SPEC>) -> Self {
        W(writer)
    }
}
