...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fetblen(&mut self) -> FETBLEN_W<BUSWCON2_SPEC, 0> {
        FETBLEN_W::new(self)
    }
    #[doc = "Bit 3 - Synchronous burst buffer mode select"]
    #[inline(always)]
    #[must_use]
    pub fn fbbmsel(&mut self) -> FBBMSEL_W<BUSWCON2_SPEC, 3> {
        FBBMSEL_W::new(self)
    }
    #[doc = "Bit 16 - Early Chip Select for Synchronous Burst"]
    #[inline(always)]
    #[must_use]
    pub fn ecse(&mut self) -> ECSE_W<BUSWCON2_SPEC, 16> {
        ECSE_W::new(self)
    }
    #[doc = "Bit 17 - Early Burst Signal Enable for Synchronous Burst"]
    #[inline(always)]
    #[must_use]
    pub fn ebse(&mut self) -> EBSE_W<BUSWCON2_SPEC, 17> {
        EBSE_W::new(self)
    }
    #[doc = "Bit 19 - Reversed polarity at WAIT"]
    #[inline(always)]
    #[must_use]
    pub fn waitinv(&mut self) -> WAITINV_W<BUSWCON2_SPEC, 19> {
        WAITINV_W::new(self)
    }
    #[doc = "Bits 20:21 - Byte Control Signal Control"]
    #[inline(always)]
    #[must_use]
    pub fn bcgen(&mut self) -> BCGEN_W<BUSWCON2_SPEC, 20> {
        BCGEN_W::new(self)
    }
    #[doc = "Bits 24:25 - External Wait Control: 0=OFF (default after reset)., 1=Asynchronous input at WAIT., 2=Synchronous input at WAIT., 3=reserved., 0=OFF (default after reset)., 1=Wait for page load (Early WAIT)., 2=Wait for page load (WAIT with data)., 3=Abort and retry access.,"]
    #[inline(always)]
    #[must_use]
    pub fn wait(&mut self) -> WAIT_W<BUSWCON2_SPEC, 24> {
        WAIT_W::new(self)
    }
    #[doc = "Bit 26 - Asynchronous Address phase:"]
    #[inline(always)]
    #[must_use]
    pub fn aap(&mut self) -> AAP_W<BUSWCON2_SPEC, 26> {
        AAP_W::new(self)
    }
    #[doc = "Bit 27 - Lock Chip Select"]
    #[inline(always)]
    #[must_use]
    pub fn lockcs(&mut self) -> LOCKCS_W<BUSWCON2_SPEC, 27> {
        LOCKCS_W::new(self)
    }
    #[doc = "Bits 28:31 - Device Type for Region"]
    #[inline(always)]
    #[must_use]
    pub fn agen(&mut self) -> AGEN_W<BUSWCON2_SPEC, 28> {
        AGEN_W::new(self)
    }
