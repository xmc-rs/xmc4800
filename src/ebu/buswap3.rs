...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wrdtacs(&mut self) -> WRDTACS_W<BUSWAP3_SPEC, 0> {
        WRDTACS_W::new(self)
    }
    #[doc = "Bits 4:6 - Recovery Cycles after Write Accesses"]
    #[inline(always)]
    #[must_use]
    pub fn wrrecovc(&mut self) -> WRRECOVC_W<BUSWAP3_SPEC, 4> {
        WRRECOVC_W::new(self)
    }
    #[doc = "Bits 7:11 - Programmed Wait States for write accesses"]
    #[inline(always)]
    #[must_use]
    pub fn waitwrc(&mut self) -> WAITWRC_W<BUSWAP3_SPEC, 7> {
        WAITWRC_W::new(self)
    }
    #[doc = "Bits 12:15 - Data Hold Cycles for Write Accesses"]
    #[inline(always)]
    #[must_use]
    pub fn datac(&mut self) -> DATAC_W<BUSWAP3_SPEC, 12> {
        DATAC_W::new(self)
    }
    #[doc = "Bits 16:17 - Frequency of external clock at pin BFCLKO"]
    #[inline(always)]
    #[must_use]
    pub fn extclock(&mut self) -> EXTCLOCK_W<BUSWAP3_SPEC, 16> {
        EXTCLOCK_W::new(self)
    }
    #[doc = "Bits 18:19 - Extended data"]
    #[inline(always)]
    #[must_use]
    pub fn extdata(&mut self) -> EXTDATA_W<BUSWAP3_SPEC, 18> {
        EXTDATA_W::new(self)
    }
    #[doc = "Bits 20:23 - Command Delay Cycles"]
    #[inline(always)]
    #[must_use]
    pub fn cmddelay(&mut self) -> CMDDELAY_W<BUSWAP3_SPEC, 20> {
        CMDDELAY_W::new(self)
    }
    #[doc = "Bits 24:27 - Address Hold Cycles"]
    #[inline(always)]
    #[must_use]
    pub fn aholdc(&mut self) -> AHOLDC_W<BUSWAP3_SPEC, 24> {
        AHOLDC_W::new(self)
    }
    #[doc = "Bits 28:31 - Address Cycles"]
    #[inline(always)]
