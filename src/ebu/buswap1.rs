...
pub struct R(crate::R<BUSWAP1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BUSWAP1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BUSWAP1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BUSWAP1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `BUSWAP1` writer"]
pub struct W(crate::W<BUSWAP1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BUSWAP1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BUSWAP1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BUSWAP1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type WRDTACS_W<'a, const O: u8> = crate::FieldWriter<'a, BUSWAP1_SPEC, 4, O, WRDTACS_A>;
...
pub type WRRECOVC_W<'a, const O: u8> = crate::FieldWriter<'a, BUSWAP1_SPEC, 3, O, WRRECOVC_A>;
...
pub type WAITWRC_W<'a, const O: u8> = crate::FieldWriter<'a, BUSWAP1_SPEC, 5, O, WAITWRC_A>;
...
pub type DATAC_W<'a, const O: u8> = crate::FieldWriter<'a, BUSWAP1_SPEC, 4, O, DATAC_A>;
...
pub type EXTCLOCK_W<'a, const O: u8> = crate::FieldWriterSafe<'a, BUSWAP1_SPEC, 2, O, EXTCLOCK_A>;
...
pub type EXTDATA_W<'a, const O: u8> = crate::FieldWriterSafe<'a, BUSWAP1_SPEC, 2, O, EXTDATA_A>;
...
pub type CMDDELAY_W<'a, const O: u8> = crate::FieldWriter<'a, BUSWAP1_SPEC, 4, O, CMDDELAY_A>;
...
pub type AHOLDC_W<'a, const O: u8> = crate::FieldWriter<'a, BUSWAP1_SPEC, 4, O, AHOLDC_A>;
...
pub type ADDRC_W<'a, const O: u8> = crate::FieldWriter<'a, BUSWAP1_SPEC, 4, O, ADDRC_A>;
