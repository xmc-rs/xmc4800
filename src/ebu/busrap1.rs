...
pub struct R(crate::R<BUSRAP1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BUSRAP1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BUSRAP1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BUSRAP1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `BUSRAP1` writer"]
pub struct W(crate::W<BUSRAP1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BUSRAP1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BUSRAP1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BUSRAP1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RDDTACS_W<'a, const O: u8> = crate::FieldWriter<'a, BUSRAP1_SPEC, 4, O, RDDTACS_A>;
...
pub type RDRECOVC_W<'a, const O: u8> = crate::FieldWriter<'a, BUSRAP1_SPEC, 3, O, RDRECOVC_A>;
...
pub type WAITRDC_W<'a, const O: u8> = crate::FieldWriter<'a, BUSRAP1_SPEC, 5, O, WAITRDC_A>;
...
pub type DATAC_W<'a, const O: u8> = crate::FieldWriter<'a, BUSRAP1_SPEC, 4, O>;
...
pub type EXTCLOCK_W<'a, const O: u8> = crate::FieldWriterSafe<'a, BUSRAP1_SPEC, 2, O, EXTCLOCK_A>;
...
pub type EXTDATA_W<'a, const O: u8> = crate::FieldWriterSafe<'a, BUSRAP1_SPEC, 2, O, EXTDATA_A>;
...
pub type CMDDELAY_W<'a, const O: u8> = crate::FieldWriter<'a, BUSRAP1_SPEC, 4, O, CMDDELAY_A>;
...
pub type AHOLDC_W<'a, const O: u8> = crate::FieldWriter<'a, BUSRAP1_SPEC, 4, O, AHOLDC_A>;
...
pub type ADDRC_W<'a, const O: u8> = crate::FieldWriter<'a, BUSRAP1_SPEC, 4, O, ADDRC_A>;
