    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn value1(self) -> &'a mut crate::W<REG> {
        self.variant(Ulpwdgt::Value1)
    }
    #[doc = "Trap request disabled"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut crate::W<REG> {
        self.variant(Ulpwdgt::Value2)
    }
}
...
impl Ecat0rstR {
    ...
    pub const fn variant(&self) -> Ecat0rst {
        match self.bits {
            false => Ecat0rst::Value1,
            true => Ecat0rst::Value2,
        }
    }
    #[doc = "Trap request enabled"]
    #[inline(always)]
    pub fn is_value1(&self) -> bool {
        *self == Ecat0rst::Value1
    }
    #[doc = "Trap request disabled"]
    #[inline(always)]
    pub fn is_value2(&self) -> bool {
        *self == Ecat0rst::Value2
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn value1(self) -> &'a mut crate::W<REG> {
        self.variant(Ecat0rst::Value1)
    }
    #[doc = "Trap request disabled"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut crate::W<REG> {
        self.variant(Ecat0rst::Value2)
    }
}
impl R {
