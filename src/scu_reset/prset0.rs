...
pub type DSDRS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, DSDRS_AW>;
impl<'a, REG, const O: u8> DSDRS_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
...
pub type CCU42RS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, CCU42RS_AW>;
impl<'a, REG, const O: u8> CCU42RS_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
...
pub type CCU81RS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, CCU81RS_AW>;
impl<'a, REG, const O: u8> CCU81RS_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
...
pub type POSIF0RS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, POSIF0RS_AW>;
impl<'a, REG, const O: u8> POSIF0RS_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
...
pub type POSIF1RS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, POSIF1RS_AW>;
impl<'a, REG, const O: u8> POSIF1RS_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dsdrs(&mut self) -> DSDRS_W<PRSET0_SPEC, 1> {
        DSDRS_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccu42rs(&mut self) -> CCU42RS_W<PRSET0_SPEC, 4> {
        CCU42RS_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccu81rs(&mut self) -> CCU81RS_W<PRSET0_SPEC, 8> {
        CCU81RS_W::new(self)
    }
    #[doc = "Bit 9 - POSIF0 Reset Assert"]
    #[inline(always)]
    #[must_use]
    pub fn posif0rs(&mut self) -> POSIF0RS_W<PRSET0_SPEC, 9> {
        POSIF0RS_W::new(self)
    }
    #[doc = "Bit 10 - POSIF1 Reset Assert"]
    #[inline(always)]
    #[must_use]
    pub fn posif1rs(&mut self) -> POSIF1RS_W<PRSET0_SPEC, 10> {
        POSIF1RS_W::new(self)
    }
