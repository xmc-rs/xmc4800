...
pub mod cgatclr2;
#[doc = "CGATSTAT3 (r) register accessor: Peripheral 3 Clock Gating Status\n\nYou can [`read`](crate::Reg::read) this register and get [`cgatstat3::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@cgatstat3`] module"]
pub type CGATSTAT3 = crate::Reg<cgatstat3::CGATSTAT3_SPEC>;
#[doc = "Peripheral 3 Clock Gating Status"]
pub mod cgatstat3;
#[doc = "CGATSET3 (w) register accessor: Peripheral 3 Clock Gating Set\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cgatset3::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@cgatset3`] module"]
pub type CGATSET3 = crate::Reg<cgatset3::CGATSET3_SPEC>;
#[doc = "Peripheral 3 Clock Gating Set"]
pub mod cgatset3;
#[doc = "CGATCLR3 (w) register accessor: Peripheral 3 Clock Gating Clear\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cgatclr3::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@cgatclr3`] module"]
pub type CGATCLR3 = crate::Reg<cgatclr3::CGATCLR3_SPEC>;
