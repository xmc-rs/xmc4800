...
pub type PD0_W<'a, const O: u8> = crate::FieldWriter<'a, PDR0_SPEC, 3, O, PD0_A>;
...
pub type PD1_W<'a, const O: u8> = crate::FieldWriter<'a, PDR0_SPEC, 3, O, PD1_A>;
...
pub type PD2_W<'a, const O: u8> = crate::FieldWriterSafe<'a, PDR0_SPEC, 3, O, PD2_A>;
...
pub type PD3_W<'a, const O: u8> = crate::FieldWriterSafe<'a, PDR0_SPEC, 3, O, PD3_A>;
...
pub type PD4_W<'a, const O: u8> = crate::FieldWriterSafe<'a, PDR0_SPEC, 3, O, PD4_A>;
...
pub type PD5_W<'a, const O: u8> = crate::FieldWriterSafe<'a, PDR0_SPEC, 3, O, PD5_A>;
...
pub type PD6_W<'a, const O: u8> = crate::FieldWriterSafe<'a, PDR0_SPEC, 3, O, PD6_A>;
...
pub type PD7_W<'a, const O: u8> = crate::FieldWriterSafe<'a, PDR0_SPEC, 3, O, PD7_A>;
