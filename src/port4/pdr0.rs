...
impl PD0_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<PD0_A> {
        match self.bits {
            0 => Some(PD0_A::SD_SHE),
            1 => Some(PD0_A::SD_MEE),
            2 => Some(PD0_A::SD_SOE),
...
pub type PD0_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O, PD0_A>;
...
impl PD1_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<PD1_A> {
        match self.bits {
            0 => Some(PD1_A::SD_SHE),
            1 => Some(PD1_A::SD_MEE),
            2 => Some(PD1_A::SD_SOE),
...
pub type PD1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O, PD1_A>;
impl<'a, REG, const O: u8> PD1_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type PD2_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 3, O, PD2_A>;
impl<'a, REG, const O: u8> PD2_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type PD3_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 3, O, PD3_A>;
impl<'a, REG, const O: u8> PD3_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type PD4_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 3, O, PD4_A>;
impl<'a, REG, const O: u8> PD4_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type PD5_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 3, O, PD5_A>;
impl<'a, REG, const O: u8> PD5_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type PD6_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 3, O, PD6_A>;
impl<'a, REG, const O: u8> PD6_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type PD7_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 3, O, PD7_A>;
impl<'a, REG, const O: u8> PD7_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
