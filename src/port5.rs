...
pub struct RegisterBlock {
    ...
    pub iocr4: IOCR4,
    #[doc = "0x18 - Port 5 Input/Output Control Register 8"]
    pub iocr8: IOCR8,
    _reserved5: [u8; 0x08],
    ...
    pub pdr0: PDR0,
    #[doc = "0x44 - Port 5 Pad Driver Mode 1 Register"]
    pub pdr1: PDR1,
    _reserved8: [u8; 0x18],
