...
pub struct MTENDS2_R(crate::FieldReader<bool, MTENDS2_A>);
impl MTENDS2_R {
    pub(crate) fn new(bits: bool) -> Self {
        MTENDS2_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for MTENDS2_R {
    type Target = crate::FieldReader<bool, MTENDS2_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct MTEU2_R(crate::FieldReader<bool, MTEU2_A>);
impl MTEU2_R {
    pub(crate) fn new(bits: bool) -> Self {
        MTEU2_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for MTEU2_R {
    type Target = crate::FieldReader<bool, MTEU2_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl MTECAT0_R {
    ...
    pub fn variant(&self) -> MTECAT0_A {
        match self.bits {
            false => MTECAT0_A::VALUE1,
            true => MTECAT0_A::VALUE2,
        }
    }
    #[doc = "Checks if the value of the field is `VALUE1`"]
    #[inline(always)]
    pub fn is_value1(&self) -> bool {
        **self == MTECAT0_A::VALUE1
    }
    #[doc = "Checks if the value of the field is `VALUE2`"]
    #[inline(always)]
    pub fn is_value2(&self) -> bool {
        **self == MTECAT0_A::VALUE2
    }
}
...
impl<'a> MTECAT0_W<'a> {
    ...
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
        self.variant(MTECAT0_A::VALUE1)
    }
    #[doc = "Parity bits under test"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut W {
        self.variant(MTECAT0_A::VALUE2)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
