...
pub struct PETEDS2_R(crate::FieldReader<bool, PETEDS2_A>);
impl PETEDS2_R {
    pub(crate) fn new(bits: bool) -> Self {
        PETEDS2_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for PETEDS2_R {
    type Target = crate::FieldReader<bool, PETEDS2_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct PETEU2_R(crate::FieldReader<bool, PETEU2_A>);
impl PETEU2_R {
    pub(crate) fn new(bits: bool) -> Self {
        PETEU2_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for PETEU2_R {
    type Target = crate::FieldReader<bool, PETEU2_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl PETEECAT0_R {
    ...
    pub fn variant(&self) -> PETEECAT0_A {
        match self.bits {
            false => PETEECAT0_A::VALUE1,
            true => PETEECAT0_A::VALUE2,
        }
    }
    #[doc = "Checks if the value of the field is `VALUE1`"]
    #[inline(always)]
    pub fn is_value1(&self) -> bool {
        **self == PETEECAT0_A::VALUE1
    }
    #[doc = "Checks if the value of the field is `VALUE2`"]
    #[inline(always)]
    pub fn is_value2(&self) -> bool {
        **self == PETEECAT0_A::VALUE2
    }
}
...
impl<'a> PETEECAT0_W<'a> {
    ...
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
        self.variant(PETEECAT0_A::VALUE1)
    }
    #[doc = "Enabled"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut W {
        self.variant(PETEECAT0_A::VALUE2)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
