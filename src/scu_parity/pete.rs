...
pub type PETEDS2_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, PETEDS2_A>;
impl<'a, REG, const O: u8> PETEDS2_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disabled"]
...
pub type PETEU2_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, PETEU2_A>;
impl<'a, REG, const O: u8> PETEU2_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disabled"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn peteds2(&mut self) -> PETEDS2_W<PETE_SPEC, 2> {
        PETEDS2_W::new(self)
    }
    #[doc = "Bit 8 - Parity Error Trap Enable for USIC0 Memory"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn peteu2(&mut self) -> PETEU2_W<PETE_SPEC, 10> {
        PETEU2_W::new(self)
    }
    #[doc = "Bit 12 - Parity Error Trap Enable for MultiCAN Memory"]
    #[inline(always)]
