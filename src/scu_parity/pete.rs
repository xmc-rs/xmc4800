...
pub type PETEDS2_W<'a, const O: u8> = crate::BitWriter<'a, u32, PETE_SPEC, PETEDS2_A, O>;
impl<'a, const O: u8> PETEDS2_W<'a, O> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
...
pub type PETEU2_W<'a, const O: u8> = crate::BitWriter<'a, u32, PETE_SPEC, PETEU2_A, O>;
impl<'a, const O: u8> PETEU2_W<'a, O> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn peteds2(&mut self) -> PETEDS2_W<2> {
        PETEDS2_W::new(self)
    }
    #[doc = "Bit 8 - Parity Error Trap Enable for USIC0 Memory"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn peteu2(&mut self) -> PETEU2_W<10> {
        PETEU2_W::new(self)
    }
    #[doc = "Bit 12 - Parity Error Trap Enable for MultiCAN Memory"]
    #[inline(always)]
