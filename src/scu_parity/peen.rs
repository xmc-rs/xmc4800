...
pub type PEENDS2_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, PEENDS2_A>;
impl<'a, REG, const O: u8> PEENDS2_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disabled"]
...
pub type PEENU2_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, PEENU2_A>;
impl<'a, REG, const O: u8> PEENU2_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disabled"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn peends2(&mut self) -> PEENDS2_W<PEEN_SPEC, 2> {
        PEENDS2_W::new(self)
    }
    #[doc = "Bit 8 - Parity Error Enable for USIC0 Memory"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn peenu2(&mut self) -> PEENU2_W<PEEN_SPEC, 10> {
        PEENU2_W::new(self)
    }
    #[doc = "Bit 12 - Parity Error Enable for MultiCAN Memory"]
    #[inline(always)]
