...
pub struct PEENDS2_R(crate::FieldReader<bool, PEENDS2_A>);
impl PEENDS2_R {
    pub(crate) fn new(bits: bool) -> Self {
        PEENDS2_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for PEENDS2_R {
    type Target = crate::FieldReader<bool, PEENDS2_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct PEENU2_R(crate::FieldReader<bool, PEENU2_A>);
impl PEENU2_R {
    pub(crate) fn new(bits: bool) -> Self {
        PEENU2_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for PEENU2_R {
    type Target = crate::FieldReader<bool, PEENU2_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl PEENECAT0_R {
    ...
    pub fn variant(&self) -> PEENECAT0_A {
        match self.bits {
            false => PEENECAT0_A::VALUE1,
            true => PEENECAT0_A::VALUE2,
        }
    }
    #[doc = "Checks if the value of the field is `VALUE1`"]
    #[inline(always)]
    pub fn is_value1(&self) -> bool {
        **self == PEENECAT0_A::VALUE1
    }
    #[doc = "Checks if the value of the field is `VALUE2`"]
    #[inline(always)]
    pub fn is_value2(&self) -> bool {
        **self == PEENECAT0_A::VALUE2
    }
}
...
impl<'a> PEENECAT0_W<'a> {
    ...
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
        self.variant(PEENECAT0_A::VALUE1)
    }
    #[doc = "Enabled"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut W {
        self.variant(PEENECAT0_A::VALUE2)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
