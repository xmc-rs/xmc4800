...
pub type SELDS2_W<'a, const O: u8> = crate::BitWriter<'a, u32, MCHKCON_SPEC, SELDS2_A, O>;
impl<'a, const O: u8> SELDS2_W<'a, O> {
    #[doc = "Not selected"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
...
pub type USIC2DRA_W<'a, const O: u8> = crate::BitWriter<'a, u32, MCHKCON_SPEC, USIC2DRA_A, O>;
impl<'a, const O: u8> USIC2DRA_W<'a, O> {
    #[doc = "Not selected"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn selds2(&mut self) -> SELDS2_W<2> {
        SELDS2_W::new(self)
    }
    #[doc = "Bit 8 - Select Memory Check for USIC0"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usic2dra(&mut self) -> USIC2DRA_W<10> {
        USIC2DRA_W::new(self)
    }
    #[doc = "Bit 12 - Select Memory Check for MultiCAN"]
    #[inline(always)]
