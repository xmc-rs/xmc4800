...
pub struct SELDS2_R(crate::FieldReader<bool, SELDS2_A>);
impl SELDS2_R {
    pub(crate) fn new(bits: bool) -> Self {
        SELDS2_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for SELDS2_R {
    type Target = crate::FieldReader<bool, SELDS2_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct USIC2DRA_R(crate::FieldReader<bool, USIC2DRA_A>);
impl USIC2DRA_R {
    pub(crate) fn new(bits: bool) -> Self {
        USIC2DRA_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for USIC2DRA_R {
    type Target = crate::FieldReader<bool, USIC2DRA_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl SELECAT0_R {
    ...
    pub fn variant(&self) -> SELECAT0_A {
        match self.bits {
            false => SELECAT0_A::VALUE1,
            true => SELECAT0_A::VALUE2,
        }
    }
    #[doc = "Checks if the value of the field is `VALUE1`"]
    #[inline(always)]
    pub fn is_value1(&self) -> bool {
        **self == SELECAT0_A::VALUE1
    }
    #[doc = "Checks if the value of the field is `VALUE2`"]
    #[inline(always)]
    pub fn is_value2(&self) -> bool {
        **self == SELECAT0_A::VALUE2
    }
}
...
impl<'a> SELECAT0_W<'a> {
    ...
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
        self.variant(SELECAT0_A::VALUE1)
    }
    #[doc = "Selected"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut W {
        self.variant(SELECAT0_A::VALUE2)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
