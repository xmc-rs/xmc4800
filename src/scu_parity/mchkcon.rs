...
pub type SELDS2_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, SELDS2_A>;
impl<'a, REG, const O: u8> SELDS2_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Not selected"]
...
pub type USIC2DRA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, USIC2DRA_A>;
impl<'a, REG, const O: u8> USIC2DRA_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Not selected"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn selds2(&mut self) -> SELDS2_W<MCHKCON_SPEC, 2> {
        SELDS2_W::new(self)
    }
    #[doc = "Bit 8 - Select Memory Check for USIC0"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usic2dra(&mut self) -> USIC2DRA_W<MCHKCON_SPEC, 10> {
        USIC2DRA_W::new(self)
    }
    #[doc = "Bit 12 - Select Memory Check for MultiCAN"]
    #[inline(always)]
